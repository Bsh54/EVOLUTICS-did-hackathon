...
import ProofRequestFullList from '../features/credential-connection/components/ProofRequestFullList';
...
type ProofRequestListScreenNavigationProp = StackNavigationProp<RootStackParamList, 'ProofRequestList'>;

const ProofRequestListScreen = () => {
  const navigation = useNavigation<ProofRequestListScreenNavigationProp>();
...
export default ProofRequestListScreen;