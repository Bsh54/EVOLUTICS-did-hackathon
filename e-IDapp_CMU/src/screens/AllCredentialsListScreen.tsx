...
import { ConnectionsFullList } from '../features/credential-connection';
...
type AllCredentialsListScreenNavigationProp = StackNavigationProp<RootStackParamList, 'AllCredentialsList'>;

const AllCredentialsListScreen = () => {
  const navigation = useNavigation<AllCredentialsListScreenNavigationProp>();

  // Header component for ConnectionsFullList
...
export default AllCredentialsListScreen;