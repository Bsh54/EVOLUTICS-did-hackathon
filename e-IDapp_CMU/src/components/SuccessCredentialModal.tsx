...
/**
 * Success modal that displays when a credential is successfully added
 */
const SuccessCredentialModal: React.FC<SuccessCredentialModalProps> = ({
    visible,
    onClose,
            ...
            <View style={styles.modalOverlay}>
                <View style={[styles.modalContainer, {
                    ...
                    <Text style={[styles.successMessage, {
                        ...
                        Your credential has been successfully added to your wallet.
                    </Text>
...
export default SuccessCredentialModal;
