...
Use Xcode to archive and distribute the iOS app. Open `ios/idsWallet.xcworkspace` in Xcode and follow standard App Store submission procedures.
...
```html
<a href="e-id://invite?oob=YOUR_BASE64_HERE"> Connect to e-ID Wallet </a>
```
